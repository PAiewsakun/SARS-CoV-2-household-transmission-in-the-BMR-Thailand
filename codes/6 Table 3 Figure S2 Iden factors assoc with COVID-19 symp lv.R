...
# select <- dplyr::select # Sometimes if you run all multiple scripts in one session, you can get MASS::select, which can cause this scripts fail to run... This line is for replacing MASS::select with dplyr::select
